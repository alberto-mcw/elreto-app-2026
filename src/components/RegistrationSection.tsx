      ...
      <div className="container max-w-xl mx-auto relative z-10">
        ...
        <div className="text-center mb-10">
          <h2 className="section-title mb-4">
            <span className="text-gradient-fire">ENTRA</span> AL RETO
          </h2>
        ...
        {submitted ? (
          ...
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-primary glow-fire-intense mb-6">
              <Check className="w-10 h-10" />
            </div>
            <h3 className="text-2xl font-bold uppercase mb-4">¡ESTÁS DENTRO!</h3>
            <p className="text-muted-foreground mb-6">
              Revisa tu email para activar tu cuenta y empezar a generar energía.
            </p>
            <Button className="btn-fire px-8 py-6 rounded-xl">
              DESCARGAR LA APP
            </Button>
          </div>
        ) : (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    className="bg-secondary/50 border-border h-12 text-base placeholder:text-muted-foreground/50 focus:border-primary focus:ring-primary"
                    required
                  />
                </div>
            ...
            <Button 
              type="submit"
              className="btn-fire w-full py-6 text-lg rounded-xl"
            >
              ENTRAR AL RETO
