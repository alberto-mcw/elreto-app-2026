      ...
      <div className="container max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-bold uppercase text-sm">MasterChef World</span>
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://www.instagram.com/mchefworldapp/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center hover:bg-primary/20 transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
