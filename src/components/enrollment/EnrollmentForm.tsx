              ...
              <div className="space-y-3 pt-2">
                <div className="flex items-start gap-2">
                  ...
                  <label htmlFor="enroll-bases" className="text-xs text-muted-foreground leading-tight cursor-pointer">
                    He leído y acepto las <a href="https://elretomcw.vercel.app/bases" onClick={(e) => handleLegalClick('https://elretomcw.vercel.app/bases', e)} className="text-primary hover:underline">Bases Legales de El Reto 2026</a>
                  </label>
                </div>
